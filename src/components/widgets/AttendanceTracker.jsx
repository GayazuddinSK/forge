  ...
  return (
    <div className="glass-panel p-6 flex flex-col h-full relative overflow-hidden">
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-xs font-tech text-gray-500 uppercase">Module: Python_Port</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-background/50 border border-surfaceBorder rounded-lg p-4 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <span className="font-tech text-gray-400 text-sm uppercase">Overall Status</span>
        ...
        <div className="bg-surface/30 border border-surfaceBorder rounded-lg p-4 flex flex-col justify-center space-y-2">
          <div className="flex justify-between items-center text-sm font-tech uppercase tracking-wider">
            ...
            <span className="text-gray-200">{data.total_classes}</span>
          </div>
          <div className="flex justify-between items-center text-sm font-tech uppercase tracking-wider">
            <span className="text-gray-500">Attended</span>
            <span className="text-gray-200">{data.attended_classes}</span>
          </div>
          <div className="flex justify-between items-center text-xs font-tech uppercase tracking-wider mt-2 border-t border-surfaceBorder pt-2">
            ...
            <span className="text-gray-400 text-[10px]">{data.last_updated}</span>
          </div>
        </div>
      </div>
        ...
        {mode === 'view' ? (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <button 
              ...
              className="bg-surface border border-surfaceBorder hover:border-arc/50 hover:text-arc text-gray-400 text-xs font-tech uppercase rounded p-2 flex flex-col items-center justify-center transition-all group"
            >
            ...
            <button 
              onClick={handleReset}
              className="bg-surface border border-surfaceBorder hover:border-stark-red/50 hover:text-stark-red text-gray-400 text-xs font-tech uppercase rounded p-2 flex flex-col items-center justify-center transition-all group"
            >
          ...
          >
            <div className="flex justify-between items-center mb-3">
              ...
              <button type="button" onClick={() => setMode('view')} className="text-gray-500 hover:text-stark-red transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-[10px] text-gray-500 font-tech uppercase mb-1">
                ...
                <input 
                  ...
                  className="w-full bg-background/50 border border-surfaceBorder rounded px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-arc/50 transition-colors"
                  placeholder="e.g. 5"
                />
              </div>
              <div>
